...
bindsym shift+XF86MonBrightnessUp exec --no-startup-id brightnessctl set +1% # increase screen brightness
bindsym shift+XF86MonBrightnessDown exec --no-startup-id brightnessctl set 1%- # decrease screen brightness
